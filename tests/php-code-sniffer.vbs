...
For Each crtStandard In CheckStandards
    WshShell.Run "D:\www\App\PHP\PHP56\php.exe D:\Git\StableLatest\vendor\squizlabs\php_codesniffer\scripts\phpcs -p -v --extensions=php -d date.timezone=""Europe/Bucharest"" --encoding=utf-8 --report=xml --standard=" & crtStandard & " " & strBaseDir & " --report-file=" & strCurDir & "\php-code-sniffer\" & crtStandard & ".xml --ignore=*/data/*,*/tests/*,*/tmp/*,*/vendor/*", 0, True
Next
